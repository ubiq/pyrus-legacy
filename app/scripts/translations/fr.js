...
ERROR_17                    : 'Il vous faut au moins 0,01 UBQ sur votre compte pour couvrir les coûts du gaz. Ajoutez des ether et réessayez. ',
...
HELP_2b_Desc_1              : 'Allez sur notre Github : [https://github.com/ubiq/pyruswallet/releases/latest](https://github.com/ubiq/pyruswallet/releases/latest). ',
...
HELP_Sec_Desc_4             : 'Vérifiez l\'URL -- Ce site est servi par Github et vous pouvez en voir le code source ici : [https://github.com/ubiq/pyruswallet/tree/gh-pages](https://github.com/ubiq/pyruswallet/tree/gh-pages) aux [https://www.myetherwallet.com](https://www.myetherwallet.com). ',
HELP_Sec_Desc_5             : 'Pour générer les portefeuilles, vous pouvez télécharger le [code source](https://github.com/ubiq/pyruswallet/releases/latest). Voir #5 ci-dessus. ',
