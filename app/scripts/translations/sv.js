...
NAV_SendEther               : 'Skicka UBQ och Tokens ',
...
x_JsonDesc                  : 'Det här är din okrypterade privata nyckel i JSON format. Det här betyder att du inte behöver ditt lösenord men vem som helst som hittar din JSON kan få tillgång till din plånbok och UBQ utan ditt lösenord. ',
x_Keystore                  : 'Keystore Fil (UTC / JSON · Rekomenderad · Krypterad) ',
x_Keystore2                 : 'Keystore Fil (UTC / JSON) ',
x_KeystoreDesc              : 'Den här Keystore filen matchar formatet som används av Fusion så du kan enkelt importera det i framtiden. Det är det rekommenderade format att hämta för backup. ',
...
MYWAL_Content_3             : 'Om du vill använda plånboken med Pyrus CX i framtiden, måste du manuellt lägga till den med hjälp av den privata nyckeln / JSON filen och lösenordet. ',
