...
NODE_Warning                : 'Noden din må være HTTPS for å muliggjøre tilkobling via MyEtherWallet.com. Du kan [laste ned MyEtherWallet-repoet & kjøre det lokalt](https://github.com/ubiq/pyruswallet/releases/latest) for å koble til en hvilken som helst node. Eller du kan skaffe deg et gratis SSL-sertifikat via [LetsEncrypt](https://letsencrypt.org/)',
...
ERROR_17                    : 'Du trenger minst 0,01 UBQ på kontoen din for å dekke gas-kostnaden. Vennligst legg til litt ether og prøv igjen. ',
...
HELP_2b_Desc_1              : 'Gå til vår github: [https://github.com/ubiq/pyruswallet/releases/latest](https://github.com/ubiq/pyruswallet/releases/latest). ',
...
HELP_3_Desc_8               : 'Hvis du planlegger å lagre et stort ether-beløp, anbefaler vi at du sender et lite beløp til- og fra den nye lommeboken før du deponerer et stort beløp. Send 0,001 UBQ til din nye lommebok, åpne lommeboken, send de 0,001 eterne (-minus gas-kostnad) til en annen adresse, og forikre deg om at alt fungerer som det skal. ',
...
HELP_8_Desc_4               : 'I tillegg er sannsynligheten for at vi tar ned MyEtherWallet svært liten. Det koster oss nesten ingenting å opprettholde den siden vi ikke lagrer noen informasjon. Hvis vi tar ned domenet, er det fortsatt, og vil alltid være, offentlig tilgjengelig på [https://github.com/ubiq/pyruswallet](https://github.com/ubiq/pyruswallet/tree/gh-pages). Du kan laste ned zip-fila der og kjøre den lokalt. ',
...
HELP_Sec_Desc_4             : 'Sjekk nettsideadressen (URL) -- Denne siden blir drevet gjennom GitHub og du kan se kildekoden her: [https://github.com/ubiq/pyruswallet/tree/gh-pages](https://github.com/ubiq/pyruswallet/tree/gh-pages) til domenet: [https://www.myetherwallet.com](https://www.myetherwallet.com). ',
HELP_Sec_Desc_5             : 'For å generere lommebøker, kan du laste ned [kildekoden](https://github.com/ubiq/pyruswallet/releases/latest). Se #5 ovenfor. ',
