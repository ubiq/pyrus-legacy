...
NODE_Warning                : 'Je node dient HTTPS te zijn om met MyEtherWallet.com te kunnen verbinden. Je kunt de [MyEtherWallet repo downloaden](https://github.com/ubiq/pyruswallet/releases/latest) en lokaal uitvoeren en vervolgens met iedere node verbinden. Of, verkrijg een gratis SSL certificaat via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Naam',
...
ERROR_17                    : 'Je hebt mininaal 0.01 UBQ in je account nodig om de in de gas kosten te voorzien. Voeg alsjeblieft wat ether toe en probeer het opnieuw. ',
...
HELP_2b_Desc_1              : 'Ga naar onze github: [https://github.com/ubiq/pyruswallet/releases/latest](https://github.com/ubiq/pyruswallet/releases/latest). ',
...
HELP_3_Desc_8               : 'Als je van plan bent om er een grote hoeveelheid ether op na te houden, raden we je aan om eerst een kleine hoeveelheid ether naar je nieuwe wallet te versturen voordat je er een grotere hoeveelheid ether naar stuurt. Stuur bijvoorbeeld 0.001 UBQ naar je nieuwe wallet, verkrijg vervolgens toegang tot dit wallet, stuur die zelfde 0.001 UBQ naar een ander adres, en controleer dat alles soepel verloopt. ',
...
HELP_Sec_Desc_4             : 'Controleer de URL -- Deze website draait vanaf GitHub en je kunt de bron code hier vinden: [https://github.com/ubiq/pyruswallet/tree/gh-pages](https://github.com/ubiq/pyruswallet/tree/gh-pages) naar de domein namen: [https://www.myetherwallet.com](https://www.myetherwallet.com). ',
HELP_Sec_Desc_5             : 'Om wallets te genereren, kun je ook de [source code](https://github.com/ubiq/pyruswallet/releases/latest) downloaden. Zie #5 hierboven. ',
