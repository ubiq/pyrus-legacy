...
NAV_SendEther               : 'Poslať UBQ a Tokens ',
...
x_JsonDesc                  : 'Toto je nezašifrovaný JSON format vášho sukromného kľúča. To znamená, že nepotrebujete heslo, ale ak niekto získa váš JSON, je schopný sprístupniť vašu peňaženku a UBQ bez hesla. ',
x_Keystore                  : 'Keystore Súbor (UTC / JSON · Odporúčané · Šifrované) ',
x_Keystore2                 : 'Keystore Súbor (UTC / JSON) ',
x_KeystoreDesc              : 'Tento Keystore súbor je rovnakého formatu ako  Fusion takže ho budete môcť jednoducho importovať. Tento subor odporúčame stiahnuť a zálohovať. ',
x_Password                  : 'Heslo ',
...
ERROR_17                    : 'You need to have at least 0.001 UBQ in your account to cover the cost of gas. Please add some UBQ and try again. ',
...
HELP_4_Desc_2               : 'Navigate to the "Poslať UBQ a Tokens" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Poslať UBQ a Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Poslať UBQ a Tokens" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Poslať UBQ a Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Poslať UBQ a Tokens" page offline? ',
