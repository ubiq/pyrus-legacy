...
NODE_Warning                : 'Il tuo nodo deve utilizzare HTTPS per potertici collegare da MyEtherWallet.com. Puoi [scaricare il repository di MyEtherWallet ed eseguirlo in locale](https://github.com/ubiq/pyruswallet/releases/latest) per collegarti ad altri tipi di nodo. Oppure, ottieni un certificato SSL gratuito tramite [LetsEncrypt](https://letsencrypt.org/)',
...
HELP_2b_Desc_1              : 'Vai su [https://github.com/ubiq/pyruswallet/releases/latest](https://github.com/ubiq/pyruswallet/releases/latest). ',
...
HELP_8_Desc_4               : 'Inoltre, la probabilità che tiriamo giù MyEtherWallet è prossima allo zero. Non ci costa praticamente nulla mantenerlo dal momento che non stiamo memorizzando alcuna informazione. Se anche disattivassimo il dominio, è ancora, e sarà sempre, disponibile pubblicamente su [https://github.com/ubiq/pyruswallet](https://github.com/ubiq/pyruswallet/tree/gh-pages). Puoi scaricare lo ZIP da lì ed eseguirlo in locale. ',
...
HELP_Sec_Desc_4             : 'Controlla l\'URL -- Questo sito viene servito attraverso GitHub e puoi vederne il codice sorgente qui: [https://github.com/ubiq/pyruswallet/tree/gh-pages](https://github.com/ubiq/pyruswallet/tree/gh-pages) su [https://www.myetherwallet.com](https://www.myetherwallet.com). ',
HELP_Sec_Desc_5             : 'Per la generazione dei portafogli, puoi scaricare il [codice sorgente](https://github.com/ubiq/pyruswallet/releases/latest) ed eseguirlo in locale. Vedi la domanda 5 qui sopra. ',
