...
NAV_SendEther               : 'Pošlji UBQ in Žetone ',
...
x_KeystoreDesc              : 'Ta datoteka za shrambo osebnega ključa Keystore se ujema s formatom datoteke, ki jo uporabljata programa Fusion, kar pomeni da ga lahko v prihodnosti enostavno izvozite iz te internetne strani in uvozite v Fusion ali Geth. Priporočamo vam da to datoteko prenesete na vaš računalnik in jo shranite na varnem mestu. Za dodatno varnost priporočamo, da datoteko shranite na večih napravah. ',
x_Password                  : 'Geslo ',
...
MEW_Tagline                 : 'Odprto-kodni JavaScript UBQ Denarnica za splošno uporabo ',
CX_Tagline                  : 'Odprto-kodni JavaScript UBQ Denarnica Chrome Dodatek za splošno uporabo ',

/* Footer */
FOOTER_1                    : 'Odprto-kodni, JavaScript, orodje za generiranje UBQ Denarnic in pošiljanje transakcij za splošno uporabo. ',
...
ADD_Warning_1               : 'V zavihek denarnic lahko dodate naslov kateregakoli obstoječega UBQ računa, ki ga želite opazovati brez da vnesete njegov osebni ključ. S tem ** ne ** dobite dostopa do računa ki ga opazujete, in ne morete izplačati Ethra s tega računa. ',
...
HELP_4_Desc_2               : 'Navigate to the "Pošlji UBQ in Žetone" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Pošlji UBQ in Žetone" page. ',
...
HELP_4CX_Desc_12            : 'Using "Pošlji UBQ in Žetone" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Pošlji UBQ in Žetone" page. ',
...
HELP_9_Title                : '9) Is the "Pošlji UBQ in Žetone" page offline? ',
