...
NODE_Warning                : 'Tu nodo debe ser HTTPS para poder conectar a él desde MyEtherWallet.com. Para conectarte a cualquier nodo, puedes [descargar el repositorio de MyEtherWallet y ejecutarlo localmente](https://github.com/ubiq/pyruswallet/releases/latest). También puedes conseguir un certificado SSL gratuito a través de [Let\'s Encrypt](https://letsencrypt.org/)',
...
ERROR_17                    : 'Es necesario tener al menos 0.01 UBQ en tu cuenta para cubrir el coste del gas. Añade algo de ether e inténtalo de nuevo. ',
...
HELP_2b_Desc_1              : 'Ve a nuestro github: [https://github.com/ubiq/pyruswallet/releases/latest](https://github.com/ubiq/pyruswallet/releases/latest). ',
...
HELP_8_Desc_4               : 'Además, la probabilidad de que cerremos MyEtherWallet es casi nula. No nos cuesta prácticamente nada mantenerlo ya que no almacenamos ninguna información. Si borramos el dominio, continúa estando disponible y siempre lo estará en [https://github.com/ubiq/pyruswallet](https://github.com/ubiq/pyruswallet/tree/gh-pages). Puedes descargar desde ahí el archivo ZIP y ejecutarlo localmente. ',
...
HELP_Sec_Desc_4             : 'Comprueba la URL -- Este sitio se sirve a través de GitHub y puedes ver el código fuente aquí: [https://github.com/ubiq/pyruswallet/tree/gh-pages](https://github.com/ubiq/pyruswallet/tree/gh-pages) a [https://www.myetherwallet.com](https://www.myetherwallet.com). ',
HELP_Sec_Desc_5             : 'Para generar carteras, puedes descargar el [código fuente](https://github.com/ubiq/pyruswallet/releases/latest). Ver #5 más arriba. ',
