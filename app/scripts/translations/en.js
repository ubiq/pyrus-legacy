...
ADD_Ledger_0a               : 'Re-open Pyrus on a secure (SSL) connection ',
...
TRANS_warning               : 'If you are using the "Only UBQ" or "Only ETC" Functions you are sending via a contract. Some services have issues accepting these transactions. Read more. ',
...
ERROR_17                    : 'You need to have **0.01 UBQ** in your account to cover the cost of gas. Please add some UBQ and try again. ',
...
ERROR_28                    : '**You need your Keystore File & Password** (or Private Key) to access this wallet in the future. Please save & back it up externally! There is no way to recover a wallet if you do not save it. Read the [help page](https://pyrus.ubiqsmart.com/#help) for instructions. ',
