...
tx_notFound_4               : 'Please use the dropdown in the top-right & select a different UBQ node (e.g. `UBQ (US) (ubiqcan.io)` or `UBQ (EU) (ubiqscan.io)` and check again.',
...
GAS_LIMIT_Desc              : 'Gas limit is the amount of gas to send with your TX. `TX fee` = gas price * gas limit & is paid to miners for including your TX in a block. Increasing this number will not get your TX mined faster. Sending UBQ = `21000`. Sending Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> UBQ here](https://www.myetherwallet.com/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Free, open-source, client-side interface for generating Ubiq wallets &amp; more. Interact with the Ubiq blockchain easily &amp; securely. Double-check the URL ( .com ) before unlocking your wallet.',
...
sidebar_donation            : 'Pyrus is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us? ',
...
ADD_Ledger_0b               : 'Re-open Pyrus using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
ADD_Ledger_scan             : 'Connect to Ledger Wallet ',

ADD_MetaMask                : 'Connect to Sparrow ',
...
MYWAL_Content_3             : 'If you want to use this wallet with your Pyrus CX in the future, you will need to manually re-add it using the private key/JSON and password. ',
...
/* full sentence reads "You are about to send "10 UBQ" to address "0x1234". Are you sure you want to do this? " */
...
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'A standard transaction using 21000 gas will cost 0.000441 UBQ. We use a slightly-above-minimum gas price of 0.000000021 UBQ to ensure it gets mined quickly. We do not take a transaction fee. ',
...
NODE_Warning                : 'Your node must be HTTPS in order to connect to it via Pyrus. You can [download the Pyrus repo & run it locally](https://github.com/ubiq/pyruswallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Name',
NODE_Port                   : 'Node Port',
...
SWAP_order_CTA              : "Please send ", // Please send 1 UBQ...
...
ERROR_17                    : 'Account you are sending from does not have enough funds. If sending tokens, you must have 0.01 UBQ in your account to cover the cost of gas. ', // 17
...
HELP_Desc                   : 'Do you see something missing? Have another question? [Get in touch with us](mailto:pyruswallet@gmail.com), and we will not only answer your question, we will update this page to be more useful to people in the future! ',
HELP_Remind_Title           : 'Some reminders ',
HELP_Remind_Desc_1          : '**Ubiq, Pyrus & Pyrus CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your UBQ to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost UBQ**. ',
HELP_Remind_Desc_2          : 'Pyrus & Pyrus CX are not "web wallets". You do not create an account or give us your UBQ to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain. ',
...
HELP_0_Desc_1               : 'Pyrus gives you the ability to generate new wallets so you can store your UBQ yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**. ',
...
HELP_2b_Title               : '2b) How do I safely / offline / cold storage with Pyrus? ',
HELP_2b_Desc_1              : 'Go to [https://github.com/ubiq/pyruswallet/releases/latest](https://github.com/ubiq/pyruswallet/releases/latest). ',
HELP_2b_Desc_2              : 'Click on `pyruswallet-vX.X.X.X.zip`. ',
...
HELP_3_Desc_3               : 'Navigate to the Pyrus "View Wallet Info" page. ',
...
HELP_3_Desc_8               : 'If you are planning on holding a large amount of ether, we recommend that send a small amount of ether from new wallet before depositing a large amount. Send 0.001 UBQ to your new wallet, access that wallet, send that 0.001 UBQ to another address, and ensure everything works smoothly. ',
...
HELP_4CX_Title              : '4) How do I send UBQ using Pyrus CX? ',
...
HELP_5_Title                : '5) How do I run Pyrus offline/locally? ',
HELP_5_Desc_1               : 'You can run Pyrus on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page. ',
HELP_5_Desc_7               : 'Pyrus is now running entirely on your computer. ',
...
HELP_5_Desc_9               : 'As we are constantly updating Pyrus, we recommend you periodically update your saved version of the repo. ',
...
HELP_8_Desc_1               : 'Pyrus is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain. ',
HELP_8_Desc_2               : 'If Pyrus goes down, you would have to find another way (like gubiq or Ubiq Wallet / Fusion) to do what we are doing. But you wouldn\'t have to "get" your UBQ out of Pyrus because it\'s not in Pyrus. It\'s in whatever wallet your generated via our site. ',
...
HELP_8_Desc_4               : 'In addition, the likelihood of us taking Pyrus down is slim to none. It costs us almost nothing to maintain as we aren\'t storing any information. If we do take the domain down, it still is, and always will be, publicly available at [https://github.com/ubiq/pyruswallet](https://github.com/ubiq/pyruswallet/tree/gh-pages). You can download the ZIP there and run it locally. ',
...
HELP_8CX_Desc_2             : 'That said, it is **very important** that you back up all your information for any new wallets generated with Pyrus CX. That way if anything happens to Pyrus CX or your computer, you still have all the information necessary to access your UBQ. See the #2a for how to back up your wallets. ',
...
HELP_12_Title               : '12) How do I import a wallet created with Pyrus into gubiq / Ubiq Wallet / Fusion? ',
HELP_12_Desc_1              : 'Using an Gubiq/Fusion JSON file from Pyrus v2+.... ',
...
HELP_13_Desc_1              : 'This means you do not have enough UBQ in your account to cover the cost of gas. Each transaction (including token and contract transactions) require gas and that gas is paid in UBQ. The number displayed is the amount required to cover the cost of the transaction in Wei. Take that number, divide by `1000000000000000000`, and subtract the amount of UBQ you were trying to send (if you were attempting to send UBQ). This will give you the amount of UBQ you need to send to that account to make the transaction. ',

HELP_14_Title               : '14) Some sites randomize (seed) the private key generation via mouse movements. Pyrus doesn\'t do this. Is the random number generation for Pyrus safe? ',
...
HELP_16_Desc_1              : 'You can use a blockchain explorer like [ubiqscan.io](http://ubiqscan.io/). Paste your address into the search bar and it will pull up your address and transaction history.',
...
HELP_Sec_Desc_4             : 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/ubiq/pyruswallet/tree/gh-pages](https://github.com/ubiq/pyruswallet/tree/gh-pages) to [https://pyrus.ubiqsmart.com](https://pyrus.ubiqsmart.com). ',
HELP_Sec_Desc_5             : 'For generating wallets, you can download the [source code and run it locally](https://github.com/ubiq/pyruswallet/releases/latest). See #5 above. ',
