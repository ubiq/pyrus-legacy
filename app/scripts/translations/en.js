...
NODE_Warning                : 'Your node must be HTTPS in order to connect to it via Pyrus. You can [download the Pyrus repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Name',
NODE_Port                   : 'Node Port',
